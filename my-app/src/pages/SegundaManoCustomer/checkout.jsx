...
export default function Checkout() {
  ...
  const [paymentMode, setPaymentMode] = useState("gcash"); // NEW
  ...
  const [voucher, setVoucher] = useState(""); // NEW
  ...
  const handlePlaceOrder = () => {
    const orderDetails = {
      ...
      paymentMode,
      referenceNumber: paymentMode === "gcash" ? referenceNumber : null,
    };
              ...
              <section className="checkout-section">
                ...
                <div className="order-type-options">
                  ...
                  >
                    ...
                    />
                    <span className="order-type-text">Delivery</span>
                  </label>
                  ...
                  >
                    ...
                    />
                    <span className="order-type-text">Pick up</span>
                  </label>
                </div>
              </section>
              ...
              <section className="checkout-section">
                ...
                <div className="order-type-options">
                  ...
                  >
                    ...
                    />
                    <span className="order-type-text">GCash</span>
                  </label>
                  ...
                  >
                    ...
                    />
                    <span className="order-type-text">Cash</span>
                  </label>
                </div>
                ...
                {paymentMode === "gcash" && (
                  <div className="gcash-section">
                    <div className="checkout-qr">
                      <img
                        src="https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=GCashPayment&bgcolor=ffffff&color=000000"
                        alt="GCash QR Code"
                      />
                    </div>
                    <div className="checkout-field">
